...
public class lilToonSetting : ScriptableObject
{
    ...
    public bool LIL_FEATURE_REALTIMEAO = true;
    ...
    public bool LIL_FEATURE_AOMask = true;
    ...
    public static void TurnOffAllShaderSetting(ref lilToonSetting shaderSetting)
    {
        ...
        shaderSetting.LIL_FEATURE_REALTIMEAO = false;
        ...
        shaderSetting.LIL_FEATURE_AOMask = false;
    ...
    public static void TurnOnAllShaderSetting(ref lilToonSetting shaderSetting)
    {
        ...
        shaderSetting.LIL_FEATURE_REALTIMEAO = true;
        ...
        if(!lilShaderAPI.IsTextureLimitedAPI())
        {
            ...
            shaderSetting.LIL_FEATURE_AOMask = true;
    ...
    public static string BuildShaderSettingString(lilToonSetting shaderSetting, bool isFile)
    {
        ...
        if (shaderSetting.LIL_FEATURE_REALTIMEAO) sb.AppendLine("#define LIL_FEATURE_REALTIMEAO");
        ...
        if (shaderSetting.LIL_FEATURE_AOMask) sb.AppendLine("#define LIL_FEATURE_AOMask");
    ...
    internal static void SetupShaderSettingFromMaterial(Material material, ref lilToonSetting shaderSetting)
    {
        ...
        if(!shaderSetting.LIL_FEATURE_REALTIMEAO && material.HasProperty("_UseRealtimeAO") && material.GetFloat("_UseRealtimeAO") != 0.0f)
        {
            logs.Add("[lilToon] LIL_FEATURE_REALTIMEAO : " + AssetDatabase.GetAssetPath(material));
            shaderSetting.LIL_FEATURE_REALTIMEAO = true;
        }
    ...
    private static void SetupShaderSettingFromAnimationClip(AnimationClip clip, ref lilToonSetting shaderSetting, bool shouldCheckMaterial = false)
    {
        ...
        foreach(var binding in AnimationUtility.GetCurveBindings(clip))
        {
            ...
            shaderSetting.LIL_FEATURE_REALTIMEAO = shaderSetting.LIL_FEATURE_REALTIMEAO || propname.Contains("_UseRealtimeAO");
    ...
    internal static void CheckTextures(ref lilToonSetting shaderSetting, Material material)
    {
        ...
        CheckTexture(ref shaderSetting.LIL_FEATURE_AOMask                , "_AOMask", material);
    ...
    internal static void CheckTextures(ref lilToonSetting shaderSetting, string propname)
    {
        ...
        shaderSetting.LIL_FEATURE_AOMask                   = shaderSetting.LIL_FEATURE_AOMask                 || propname.Contains("_AOMask");
