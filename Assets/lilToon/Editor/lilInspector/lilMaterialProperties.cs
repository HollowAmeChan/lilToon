...
namespace lilToon
{
    public partial class lilToonInspector
    {
        ...
        private readonly lilMaterialProperty htraceSSGIBackfaceNormalFix = new lilMaterialProperty("_HTraceSSGIBackfaceNormalFix", PropertyBlock.GIAO);
        ...
        private readonly lilMaterialProperty aoDarkStrength             = new lilMaterialProperty("_AODarkStrength", PropertyBlock.Shadow);
        ...
        private readonly lilMaterialProperty liquidUnderlayTex         = new lilMaterialProperty("_LiquidUnderlayTex", PropertyBlock.Liquid);
        ...
        private readonly lilMaterialProperty outlineShadowStrength      = new lilMaterialProperty("_OutlineShadowStrength", PropertyBlock.Outline);
